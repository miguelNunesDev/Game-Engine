...
var Handler = /** @class */ (function (_super) {
    ...
    function Handler(pos, size, parent, shape, stroke) {
        ...
        _this = _super.call(this, { position: position, size: size }, parent) || this;
    ...
    Handler.prototype.getShape = function (shape) {
        var _this = this;
        var formType = {
            circle: function () { return new Circle(_this.transform.center.x, _this.transform.center.y, _this.transform.size.w * 0.5, {}, _this); },
            square: function () { return new Square({ position: _this.transform.position, size: _this.transform.size, rotation: 0 }, _this, _this.stroke, 'white'); }
        };
